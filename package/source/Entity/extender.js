import build from '@crawlo/entity/build'
import bind from '@crawlo/entity/bind'
import {
    getEntityType,
    getInputObjectType,
    getErrorType,
...
export default function extender(Entity) {
    ...
    GraphQLEntity[GraphQLEntity.query] = function (resolve, options = {
        args: {}
    }) {
        this[Entity.context].forEach(
            key =>
        ...
        return getQueryConfig(
            ...
            this[GraphQLEntity.bindContext](args, context).then(
                () =>
                resolve(source, args, context, info, logger)
            ),
            options
        )
    }
    ...
    GraphQLEntity[GraphQLEntity.listQuery] = function (resolve, options = {
        fields: {},
        args: {}
    }) {
        this[Entity.context].forEach(
    ...
    GraphQLEntity[GraphQLEntity.mutation] = function (resolve, options = {
        fields: {},
        args: {},
        errorFields: {}
    }) {
    ...
    GraphQLEntity[GraphQLEntity.subscription] = function (subscribe, options = {
        args: {},
        resolve: undefined
    }) {
        this[Entity.context].forEach(
        ...
        options.resolve = (source, args, context, info) =>
            this[GraphQLEntity.bindContext](args, context).then(
                () =>
                resolve ? resolve(source, args, context, info, logger) : source
            )
        if (!subscribe)
