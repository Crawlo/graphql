import Entity from '@crawlo/entity/MongoDB'
...
MongoDBEntity[MongoDBEntity.query] = function (resolve, options = {
    args: {}
}) {
    if (!resolve) {
...
MongoDBEntity[MongoDBEntity.listQuery] = function (resolve, options = {
    fields: {},
    args: {}
}) {
    if (!resolve) {
...
MongoDBEntity[MongoDBEntity.mutation] = function (resolve, options = {
    fields: {},
    args: {},
    errorFields: {}
}) {
